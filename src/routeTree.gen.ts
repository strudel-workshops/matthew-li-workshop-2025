...
const RecommendedMoviesIndexRoute = RecommendedMoviesIndexImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/recommended-movies/': {
      id: '/recommended-movies/'
      path: '/recommended-movies'
      fullPath: '/recommended-movies'
      preLoaderRoute: typeof RecommendedMoviesIndexImport
      parentRoute: typeof rootRoute
    }
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/recommended-movies/": {
      "filePath": "recommended-movies/index.tsx"
    },
    "/search-data-repositories/": {
